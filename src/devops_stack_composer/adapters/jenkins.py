...
def _render_jenkinsfile(model: NormalizedDevOpsModel) -> str:
    ...
    lines = [
        ...
        "// Static Jenkins contract only: controller-backed execution is not verified in v0.2.",
        "pipeline {",
        "    agent any",
        "",
        "    options {",
...
def _render_boundary(model: NormalizedDevOpsModel, template_commit: str) -> str:
    ...
    return "\n".join(
        [
            ...
            "- v0.2 validates this generated plan statically. It does not claim Jenkins",
